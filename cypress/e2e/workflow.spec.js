describe('Workflow details', () => {
  ...
  describe('Workflow details - Logs', () => {
    ...
    it('Show log list of a workflow', () => {
      ...
      cy.get('.workflow-log-item').eq(0).should('contain', 'success').and('contain', 'Jun 10th 2023, 12:46:28');
      cy.get('.workflow-log-item').eq(2).should('contain', 'failed').and('contain', 'Jun 10th 2023, 12:43:30');
    });
